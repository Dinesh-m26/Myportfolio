  ...
  return (
    <div className='md:py-7 md:pt-9 mx-auto '>
      ...
      <div className='flex flex-col md:flex-row items-center justify-center py-1'>
        <a href="https://drive.google.com/drive/folders/147vHrl_4cP1KpXTdvYm8E03fFwgmA_uc?usp=sharing" className='text-[#90A0D9] border border-[#90A0D9] hover:bg-[#90A0D9] hover:text-[#23283E] hover:border-[#23283E] px-3 py-2 mb-3 md:mb-0 md:mr-3'>Resume</a>
